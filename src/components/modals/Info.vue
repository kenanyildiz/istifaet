<template>
  <b-modal id="infoModal" v-model="isDisplay"
    ...
    <div slot="modal-footer" class="w-100 text-right">
      <b-btn variant="custom btn-outline-dark" data-dismiss="modal" @click="modalDisplayChanged($event, { name: 'infoModalOpt', display: false, source: null })">
        {{ $t("close") }}
      </b-btn>
    </div>
  </b-modal>
